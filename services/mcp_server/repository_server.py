...
@mcp.tool()
def context_lookup(query: str, top_k: int):
    # Use this tool to search for and retrieve specific transaction data, historical records,
    # or contextual information from the database using natural language queries.
